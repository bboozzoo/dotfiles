...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-themes '(tangotango naquadah)
   ...
   dotspacemacs-default-font (let ((host (system-name)))
                               (cond ((string= host "galeon")
                                      '("Ubuntu Mono"
                                        :size 20
                                        :weight normal
                                        :width normal
